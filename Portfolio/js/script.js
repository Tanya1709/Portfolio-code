$(document).ready(function(){
  ...
  const funFacts = [
    ...
    "I enjoy solving problem",
    "I love brainstorming ideas and concepts ",
    "I am interested in working in a team of people who think differently than me",
  ...
  $('#preloader-title').text("As a Designer");
